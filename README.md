...
`example/jv32soc.kanata` — pipeline trace generated by the **J<sub>V</sub>32** RISC-V core running a SoC simulation.

- Core: [J<sub>V</sub>32](https://github.com/kuopinghsu/jv32) — a lightweight RISC-V RV32IMC processor
- Load it via **📁 Open** or drag-and-drop onto the viewer
